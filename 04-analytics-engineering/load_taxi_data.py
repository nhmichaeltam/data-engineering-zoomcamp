...
BUCKET_NAME = "04-analytics-engineering-nhmichaeltam"

# # If you authenticated through the GCP SDK you can comment out these two lines
# CREDENTIALS_FILE = "gcs.json"
# client = storage.Client.from_service_account_json(CREDENTIALS_FILE)
# If commented initialize client with the following
client = storage.Client(project='nhmichaeltam-DE-zoomcamp')
...
if __name__ == "__main__":
    ...
    # Generate all combinations of taxi types, years, and months
    tasks = [(taxi_type, year, month) for taxi_type in TAXI_TYPE for year in YEARS for month in MONTHS]
